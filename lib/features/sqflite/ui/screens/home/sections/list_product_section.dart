...
import 'package:personal_proyects/features/sqflite/data/datasource/localdata/database/dao/product_dao.dart';
...
class GridListWidget extends ConsumerStatefulWidget {
  ...
  @override
  GridListWidgetState createState() => GridListWidgetState();
}

class GridListWidgetState extends ConsumerState<GridListWidget> {
  @override
  Widget build(BuildContext context) {
